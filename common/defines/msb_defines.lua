...
NDefines.NDiplomacy.PEACE_SCORE_DISTRIBUTION = { 1.0 }					-- All peace score up front in one pass (PEACE_SCORE_PER_PASS was removed in 1.19)
...
-- ===== AMSB 2026-08-12: ZHM-parity performance adoption (user-approved groups) =====
-- Group 1: AI recalculation throttles (AI-only; no player-visible mechanics change)
...
NDefines.NAI.AI_NAVAL_GOALS_UPDATE_FREQUENCY_DAYS = 28
NDefines.NAI.AI_OBJECTIVE_DEFAULT_TARGET_RECALC_DAYS = 28
NDefines.NAI.AI_PREFERRED_TACTIC_WEEKLY_CHANGE_CHANCE = 0
NDefines.NAI.AI_UPDATE_ROLES_FREQUENCY_HOURS = 672
NDefines.NAI.CONSTRUCTION_PRIO_FACTOR_OCCUPIED_TERRITORY = 0.01
NDefines.NAI.CONSTRUCTION_PRIO_FACTOR_OWNED_NONCORE = 0.10
NDefines.NAI.CONVOY_RAIDING_TARGET_RECALC_DAYS = 180
NDefines.NAI.DAYS_BETWEEN_AIR_PRIORITIES_UPDATE = 28
NDefines.NAI.DAYS_BETWEEN_CHECK_BEST_DOCTRINE = 365
NDefines.NAI.DAYS_BETWEEN_CHECK_BEST_EQUIPMENT = 28
NDefines.NAI.DAYS_BETWEEN_CHECK_BEST_TEMPLATE = 28
...
NDefines.NAI.RAIDS_CREATE_FREQUENCY_DAYS = 9999
NDefines.NAI.RAIDS_ENABLE_AI = false
NDefines.NAI.RESEARCH_DAYS_BETWEEN_WEIGHT_UPDATE = 28
NDefines.NAI.STRIKE_FORCE_TARGET_RECALC_DAYS = 28
NDefines.NAI.TOTAL_STATE_EXTRACTED_RESOURCES_FOR_BUILDING_RESOURCE_CAP_BUILDING = 100
NDefines.NAI.UPDATE_SUPPLY_BOTTLENECKS_FREQUENCY_HOURS = 672
NDefines.NAI.UPDATE_SUPPLY_MOTORIZATION_FREQUENCY_HOURS = 168
NDefines.NAir.STRATEGIC_BOMBING_RAILWAY_PRIORITY_SCALE = 0
-- Group 2: client render throttles (visual-perf only)
...
-- Group 4: equipment market disabled (ZHM pattern; MP sync-heavy system off)
...
NDefines.NMarket.MAX_CIV_FACTORIES_PER_CONTRACT = 1
